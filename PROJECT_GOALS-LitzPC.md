...
## Memory System Validation Goals

Track these metrics throughout development:

### Phase 1 (File Cache)
- Task 1: Hit rate 0% (expected - first task)
- Task 2: Hit rate 20-30%
- Task 5: Hit rate 40-50%
- Task 9: Hit rate 65-70%

### Phase 2 (Codebase Map)
- Task 1: Map built in <5ms
- Task 2+: Map loaded from cache (instant)
- All tasks: No repeated list_directory calls

### Phase 3 (Task History)
- Task 1: No prediction
- Task 2-3: 30-50% confidence
- Task 4-6: 60-80% confidence
- Task 7-10: 85-100% confidence
- File suggestions appear from Task 3+
- Cost predictions within ±20% by Task 5

### Overall Savings
- Expected total: 65-70% API cost reduction
- Without memory: ~$0.40 for 10 tasks
- With memory: ~$0.13 for 10 tasks
- **Savings: ~$0.27 (67%)**
...
# After task completes, test it
cd ../workspace/test-project
npm install
node src/task.js add "Test task"
node src/task.js list
```
